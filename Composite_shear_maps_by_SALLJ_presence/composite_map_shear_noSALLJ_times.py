...
if Calculate == True:
    ...
    variable_spatial_noSALLJ_times = np.empty((len(noSALLJ_time_list), 499, 599))
    variable_spatial_noSALLJ_times[:] = np.NaN
    ...
    for noSALLJ_time in noSALLJ_time_list_arr_dt:
        ...
        variable_spatial_noSALLJ_times[noSALLJ_count,:,:] = mag_diff
    ...
    pickle.dump(mean_variable_spatial_noSALLJ_times, open("mean_%s_noSALLJ_times_%s_%s.dat" %('0_6km_shear', start_date, end_date), "wb"))
...
if Plot == True:
    ...
    mean_variable_spatial_noSALLJ_times = pickle.load(open("mean_%s_noSALLJ_times_%s_%s.dat" %('0_6km_shear', start_date, end_date), "rb"))
    ...
    plt.savefig(outpath + 'shear_0_6km_composite_map_noSALLJ_times_%s_%s_%s.png' %(start_date, end_date, noSALLJ_location))
