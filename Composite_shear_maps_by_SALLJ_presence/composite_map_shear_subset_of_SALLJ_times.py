...
Uses '3relaxed_SALLJ_times_VMRS_1101_0430.dat' and '3relaxed_SALLJ_level_max_VMRS_1101_0430.dat' file copied over. See README for more.
...
if Calculate == True:
    ...
    level_max_list = pickle.load(open("3relaxed_SALLJ_level_max_%s_%s_%s.dat" %(SALLJ_location, start_date, end_date), "rb"))

    # convert to arrays of correct data types
    SALLJ_time_list_arr = np.array([str(SALLJ_time) for SALLJ_time in SALLJ_time_list])
    level_max_list_arr = np.array([float(level_max) for level_max in level_max_list])
    
    # get indices of time when jet is above threshold
    index_jet_core_grt1750m = np.where(level_max_list_arr < subset_by_SALLJ_heigth_above)[0]
    
    # get times when SALLJ core is above 1750 m
    SALLJ_time_list_arr = SALLJ_time_list_arr[index_jet_core_grt1750m]
    
    # convert times to datetime format
    SALLJ_time_list_arr_dt = [datetime.datetime.strptime(date, '%Y-%m-%d %H:%M:%S') for date in SALLJ_time_list_arr]
    
    print(len(SALLJ_time_list_arr_dt))
    level_max_list_arr = level_max_list_arr[index_jet_core_grt1750m]
    print(level_max_list_arr)
    ...
    pickle.dump(mean_variable1_spatial_SALLJ_times, open("mean_%s_subset_peak_below_%sm_SALLJ_times_%s_%s.dat" %('0_6km_shear', subset_by_SALLJ_heigth_above, start_date, end_date), "wb"))
    ...
    pickle.dump(mean_variable2_spatial_SALLJ_times, open("mean_%s_subset_peak_below_%sm_SALLJ_times_%s_%s.dat" %('0_3km_shear', subset_by_SALLJ_heigth_above, start_date, end_date), "wb"))
    ...
    pickle.dump(mean_variable3_spatial_SALLJ_times, open("mean_%s_subset_peak_below_%sm_SALLJ_times_%s_%s.dat" %('2_6km_shear', subset_by_SALLJ_heigth_above, start_date, end_date), "wb"))
...
if Plot == True:
    ...
    mean_variable_spatial_SALLJ_times = pickle.load(open("mean_%s_subset_peak_below_%sm_SALLJ_times_%s_%s.dat" %('0_6km_shear', subset_by_SALLJ_heigth_above, start_date, end_date), "rb"))
    ...
    plt.savefig(outpath + 'shear_0_6km_composite_map_subset_peak_below_%sm_SALLJ_times_%s_%s_%s.png' %(subset_by_SALLJ_heigth_above, start_date, end_date, SALLJ_location))
