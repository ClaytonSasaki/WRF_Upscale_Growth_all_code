...
general_outpath = '/home/disk/meso-home/crs326/Documents/Research/WRF_Upscale_Growth_Paper/2MCS_characteristics_vs_environment/'
...
pickle.dump(mean_bulk_shear_0_3km, open(general_outpath + specific_outpath + "%s_mean_bulk_shear_0_3km%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(mean_bulk_shear_0_6km, open(general_outpath + specific_outpath + "%s_mean_bulk_shear_0_6km%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(mean_bulk_shear_2_6km, open(general_outpath + specific_outpath + "%s_mean_bulk_shear_2_6km%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(q_850, open(general_outpath + specific_outpath + "%s_q_850%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(prop_area_SALLJ, open(general_outpath + specific_outpath + "%s_prop_area_SALLJ%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(median_SALLJ_max_wind, open(general_outpath + specific_outpath + "%s_median_SALLJ_max_wind%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(median_SALLJ_height, open(general_outpath + specific_outpath + "%s_median_SALLJ_height%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
