...
plt.savefig(general_outpath + '/5%s%s%s_initCentroids_%s_%s%s%s.png' %(MCS_file_label, offset_label, var_seperation_label, shear_type, MCS_init_area, dir_shear_label, events_removed_label), dpi=600)
