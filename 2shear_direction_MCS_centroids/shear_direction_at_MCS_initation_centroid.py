...
first_MCS_bol_array_plus2 = np.zeros_like(MCS_status, dtype=bool)
...
for i in range(MCS_status.shape[0]):
    ...
    if 1 in MCS_status[i]:
        ...
        first_MCS_bol_array_plus2[i, first_one_index+2] = True
...
MCS_majoraxislength_init_3 = np.array(MCS_tracks_ncfile.variables['majoraxislength'])[first_MCS_bol_array_plus2]
MCS_majoraxislength_init_4 = np.array(MCS_tracks_ncfile.variables['majoraxislength'])[first_MCS_bol_array_plus3]
...
MCS_ccs_area_init_3 = np.array(MCS_tracks_ncfile.variables['ccs_area'])[first_MCS_bol_array_plus2]
...
MCS_ccs_meantb_init = np.array(MCS_tracks_ncfile.variables['ccs_meantb'])[first_MCS_bol_array]
MCS_ccs_meantb_init_2 = np.array(MCS_tracks_ncfile.variables['ccs_meantb'])[first_MCS_bol_array_plus1]
MCS_ccs_meantb_init_3 = np.array(MCS_tracks_ncfile.variables['ccs_meantb'])[first_MCS_bol_array_plus2]
MCS_ccs_meantb_init_4 = np.array(MCS_tracks_ncfile.variables['ccs_meantb'])[first_MCS_bol_array_plus3]
...
general_outpath = '/home/disk/meso-home/crs326/Documents/Research/WRF_Upscale_Growth_Paper/2shear_direction_MCS_centroids'
