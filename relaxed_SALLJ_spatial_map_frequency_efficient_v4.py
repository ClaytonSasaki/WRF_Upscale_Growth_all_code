...
pres_max_wind_SALLJs_for_all_times = np.empty((499, 599))
pres_max_wind_SALLJs_for_all_times[:] = np.NaN
        ...
        for hourly_file in sorted_hour_files:
            ...
            if hourly_file.startswith('wrfout'):
                ...
                while(terrain_plotted == False):
                    ...
                    pickle.dump(terrain, open("NEW_relaxed_SALLJ_frequency_v4_terrain.dat", "wb"))
                    
                    pickle.dump(lats, open("NEW_relaxed_SALLJ_frequency_v4_lats.dat", "wb"))
                    
                    pickle.dump(lons, open("NEW_relaxed_SALLJ_frequency_v4_lons.dat", "wb"))
                    
                    pickle.dump(cart_proj, open("NEW_relaxed_SALLJ_frequency_v4_cart_proj.dat", "wb"))
