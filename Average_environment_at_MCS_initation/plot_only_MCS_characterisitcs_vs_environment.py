...
MCS_prop_area_SALLJ = pickle.load(open("MCS_prop_area_SALLJ%s.dat" %(filter_label), "rb"))
...
MCS_duration_filtered = pickle.load(open("MCS_duration2%s.dat" %(filter_label), "rb"))
MCS_majoraxislength_growth_filtered = pickle.load(open("MCS_majoraxislength_growth%s.dat" %(filter_label), "rb"))
mean_bulk_shear_0_3km = pickle.load(open("MCS_mean_bulk_shear_0_3km%s.dat" %(filter_label), "rb"))
mean_bulk_shear_0_6km = pickle.load(open("MCS_mean_bulk_shear_0_6km%s.dat" %(filter_label), "rb"))
mean_bulk_shear_2_6km = pickle.load( open("MCS_mean_bulk_shear_2_6km%s.dat" %(filter_label), "rb"))
median_SALLJ_max_wind = pickle.load( open("MCS_median_SALLJ_max_wind%s.dat" %(filter_label), "rb"))
median_SALLJ_height = pickle.load( open("MCS_median_SALLJ_height%s.dat" %(filter_label), "rb"))
...
plt.savefig('2%s_vs_%s_scatter%s.png' %(filename_y, filename_x, filter_label), dpi=200)
