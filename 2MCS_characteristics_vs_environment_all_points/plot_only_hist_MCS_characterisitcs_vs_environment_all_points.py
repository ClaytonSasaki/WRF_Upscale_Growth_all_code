...
general_path = '/home/disk/meso-home/crs326/Documents/Research/WRF_Upscale_Growth_Paper/2MCS_characteristics_vs_environment_all_points/'
...
variable_name = 'MCS_q_flux_850_v' # MCS_prop_area_SALLJ, bulk_shear_0_3km, MCS_q_850, MCS_MUCAPE, MCS_wv_flux_850_v ...
var_label = '850hPa q v flux (m/s)' # proportion of area w/SALLJ, bulk 0-3 km shear, 850-hPa q, MUCAPE (J/kg), 850hPa v wv flux (m/s) ...
...
plt.savefig(general_path + specific_outpath + '%s_%s_by_%s%d%s%s%s%s%s.png' %(variable_name, plot_type, var_seperation_name, seperation_threshold, dist_text_all_growth, dist_text_rapid_growth, dist_text_slow_growth, filter_label, dBZ_label), dpi=200)
