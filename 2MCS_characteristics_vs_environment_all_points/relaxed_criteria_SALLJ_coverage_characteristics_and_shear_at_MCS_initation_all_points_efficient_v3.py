...
based on file with similar name in MCS_characteristics_vs_environment directory (relaxed_criteria_SALLJ_coverage_characteristics_and_shear_at_MCS_initation_efficient_v3.py)
...
print('MCS_ccs_area_filtered', MCS_ccs_area_filtered)
...
general_outpath = '/home/disk/meso-home/crs326/Documents/Research/WRF_Upscale_Growth_Paper/2MCS_characteristics_vs_environment_all_points/'
...
pickle.dump(MCS_duration_all_points, open(general_outpath + specific_outpath + "%s%s_duration2_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(MCS_majoraxislength_growth_all_points, open(general_outpath + specific_outpath + "%s%s_majoraxislength_growth_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(MCS_ccs_area_growth_all_points, open(general_outpath + specific_outpath + "%s%s_ccs_area_growth_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(MCS_ccs_area_growth_2hr_all_points, open(general_outpath + specific_outpath + "%s%s_ccs_area_growth_2hr_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(bulk_shear_0_3km, open(general_outpath + specific_outpath + "%s%s_bulk_shear_0_3km_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(bulk_shear_0_6km, open(general_outpath + specific_outpath + "%s%s_bulk_shear_0_6km_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(bulk_shear_2_6km, open(general_outpath + specific_outpath + "%s%s_bulk_shear_2_6km_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(q_850, open(general_outpath + specific_outpath + "%s%s_q_850_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(MUCAPE, open(general_outpath + specific_outpath + "%s%s_MUCAPE_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(wv_flux_850_v, open(general_outpath + specific_outpath + "%s%s_wv_flux_850_v_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(q_flux_850, open(general_outpath + specific_outpath + "%s%s_q_flux_850_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(q_flux_850_v, open(general_outpath + specific_outpath + "%s%s_q_flux_850_v_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(max_refl, open(general_outpath + specific_outpath + "%s%s_max_refl_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(refl_coverage_grt0, open(general_outpath + specific_outpath + "%s%s_refl_coverage_grt0_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(refl_coverage_grt30, open(general_outpath + specific_outpath + "%s%s_refl_coverage_grt30_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(prop_area_SALLJ_all_points, open(general_outpath + specific_outpath + "%s%s_prop_area_SALLJ_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(median_SALLJ_max_wind_all_points, open(general_outpath + specific_outpath + "%s%s_median_SALLJ_max_wind_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(median_SALLJ_height_all_points, open(general_outpath + specific_outpath + "%s%s_median_SALLJ_height_all_points_byEvent%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
...
pickle.dump(MCS_duration_all_points, open(general_outpath + specific_outpath + "%s%s_duration2_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(MCS_majoraxislength_growth_all_points, open(general_outpath + specific_outpath + "%s%s_majoraxislength_growth_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(MCS_ccs_area_growth_all_points, open(general_outpath + specific_outpath + "%s%s_ccs_area_growth_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(MCS_ccs_area_growth_2hr_all_points, open(general_outpath + specific_outpath + "%s%s_ccs_area_growth_2hr_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(bulk_shear_0_3km, open(general_outpath + specific_outpath + "%s%s_bulk_shear_0_3km_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(bulk_shear_0_6km, open(general_outpath + specific_outpath + "%s%s_bulk_shear_0_6km_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(bulk_shear_2_6km, open(general_outpath + specific_outpath + "%s%s_bulk_shear_2_6km_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(q_850, open(general_outpath + specific_outpath + "%s%s_q_850_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(MUCAPE, open(general_outpath + specific_outpath + "%s%s_MUCAPE_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(wv_flux_850_v, open(general_outpath + specific_outpath + "%s%s_wv_flux_850_v_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(q_flux_850_v, open(general_outpath + specific_outpath + "%s%s_q_flux_850_v_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(q_flux_850, open(general_outpath + specific_outpath + "%s%s_q_flux_850_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(max_refl, open(general_outpath + specific_outpath + "%s%s_max_refl_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(prop_area_SALLJ_all_points, open(general_outpath + specific_outpath + "%s%s_prop_area_SALLJ_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(median_SALLJ_max_wind_all_points, open(general_outpath + specific_outpath + "%s%s_median_SALLJ_max_wind_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
pickle.dump(median_SALLJ_height_all_points, open(general_outpath + specific_outpath + "%s%s_median_SALLJ_height_all_points%s_%s_%s_%s.dat" %(MCS_file_label, offset_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "wb"))
# Note: this could be improved by using a dict object
