...
Gets MCS lat/lon centroid and times at initiation for MCSs in a defined region near SDC. !!!!!ONLY USING ROBUST MCSs!!!!!
...
pickle.dump(MCS_duration_filtered, open("robust_MCS_duration2%s.dat" %(filter_label), "wb"))
pickle.dump(MCS_majoraxislength_growth_filtered, open("robust_MCS_majoraxislength_growth%s.dat" %(filter_label), "wb"))
pickle.dump(mean_bulk_shear_0_3km, open("robust_MCS_mean_bulk_shear_0_3km%s.dat" %(filter_label), "wb"))
pickle.dump(mean_bulk_shear_0_6km, open("robust_MCS_mean_bulk_shear_0_6km%s.dat" %(filter_label), "wb"))
pickle.dump(mean_bulk_shear_2_6km, open("robust_MCS_mean_bulk_shear_2_6km%s.dat" %(filter_label), "wb"))
pickle.dump(q_850, open("robust_MCS_q_850%s_%s.dat" %(filter_label, MCS_init_area), "wb"))
pickle.dump(prop_area_SALLJ, open("robust_MCS_prop_area_SALLJ%s.dat" %(filter_label), "wb"))
pickle.dump(median_SALLJ_max_wind, open("robust_MCS_median_SALLJ_max_wind%s.dat" %(filter_label), "wb"))
pickle.dump(median_SALLJ_height, open("robust_MCS_median_SALLJ_height%s.dat" %(filter_label), "wb"))
