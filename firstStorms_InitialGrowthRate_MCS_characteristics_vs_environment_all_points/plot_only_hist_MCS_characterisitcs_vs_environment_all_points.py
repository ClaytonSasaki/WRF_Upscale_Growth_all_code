...
# read in files
MCS_prop_area_SALLJ = pickle.load(open(general_path + specific_inpath + "2%s_prop_area_SALLJ_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
...
MCS_duration_filtered = pickle.load(open(general_path + specific_inpath + "2%s_duration2_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
MCS_majoraxislength_growth_filtered = pickle.load(open(general_path + specific_inpath + "2%s_majoraxislength_growth_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
MCS_ccs_area_growth_filtered = pickle.load(open(general_path + specific_inpath + "2%s_ccs_area_growth_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
MCS_growth_stage_time_length_filtered = pickle.load(open(general_path + specific_inpath + "2%s_growth_stage_time_length_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
...
bulk_shear_0_3km = pickle.load(open(general_path + specific_inpath + "2%s_bulk_shear_0_3km_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
bulk_shear_0_6km = pickle.load(open(general_path + specific_inpath + "2%s_bulk_shear_0_6km_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
bulk_shear_2_6km = pickle.load(open(general_path + specific_inpath + "2%s_bulk_shear_2_6km_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
median_SALLJ_max_wind = pickle.load(open(general_path + specific_inpath + "2%s_median_SALLJ_max_wind_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
median_SALLJ_height = pickle.load(open(general_path + specific_inpath + "2%s_median_SALLJ_height_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
MCS_q_850 = pickle.load(open(general_path + specific_inpath + "2%s_q_850_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
MCS_MUCAPE = pickle.load(open(general_path + specific_inpath + "2%s_MUCAPE_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))
...
MCS_wv_flux_850_v = pickle.load(open(general_path + specific_inpath + "2%s_wv_flux_850_v_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb")) # used m/s for wind
MCS_q_flux_850 = pickle.load(open(general_path + specific_inpath + "2%s_q_flux_850_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb")) # used m/s for wind
MCS_q_flux_850_v = pickle.load(open(general_path + specific_inpath + "2%s_q_flux_850_v_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb")) # used m/s for wind

#### used to remove points w/reflectivity over certain threshold ####

MCS_max_refl_all_points = pickle.load( open(general_path + specific_inpath + "2%s_max_refl_all_points%s_%s_%s_%s.dat" %(MCS_file_label, filter_label, MCS_init_area, SALLJ_search_area, env_search_area), "rb"))

print(bulk_shear_0_3km.size)
print(MCS_max_refl_all_points.size)
...
data = MCS_q_850
variable_name = 'MCS_q_850' # MCS_prop_area_SALLJ, bulk_shear_0_3km, MCS_q_850, MCS_MUCAPE, MCS_wv_flux_850_v ...
var_label = '850-hPa q' # proportion of area w/SALLJ, bulk 0-3 km shear (kts), 850-hPa q, MUCAPE (J/kg), 850hPa v wv flux (m/s) ...

############ Change variable for seperation ############

var_seperation = MCS_ccs_area_growth_rate_filtered
var_seperation_name = 'ccs_area_growth_rate'
seperation_threshold = q25_MCS_ccs_area_growth_rate_filtered
...
mask_rapid_growth = var_seperation >= q75_MCS_ccs_area_growth_rate_filtered
mask_slow_growth = var_seperation < q25_MCS_ccs_area_growth_rate_filtered
...
plt.savefig(general_path + specific_outpath + '3%s_%s_by_%s%d%s%s%s%s%s.png' %(variable_name, plot_type, var_seperation_name, seperation_threshold, dist_text_all_growth, dist_text_rapid_growth, dist_text_slow_growth, filter_label, dBZ_label), dpi=200)
