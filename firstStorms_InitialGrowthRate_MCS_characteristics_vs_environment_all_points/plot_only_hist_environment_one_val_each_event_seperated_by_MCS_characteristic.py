...
data_all_growth = q_850_spreadByEvent
data_rapid_growth = q_850_spreadByEvent
data_slow_growth = q_850_spreadByEvent
variable_name = 'q_850_spreadByEvent' # q_850_spreadByEvent, bulk_shear_0_3km_spreadByEvent, MCS_MUCAPE_quart90ByEvent, MCS_wv_flux_quart90ByEvent, q_850_mean, MCS_MUCAPE_mean
x_label = '850hPa q spread by event' # 850hPa q spread by event, 0-3km bulk shear spread by event
...
plt.savefig(general_path + specific_outpath + '5%s_hist_by_%s_%d%s%s%s%s%s.png' %(variable_name, var_seperation_name, seperation_threshold, dist_text_all_growth, dist_text_rapid_growth, dist_text_slow_growth, filter_label, events_removed_label), dpi=200)
