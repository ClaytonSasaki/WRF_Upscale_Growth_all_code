...
#    ylabel = 'ccs growth rate (km2/hr)'
    ...
    filetype_label = '%s_vs_%s_scatter' %(filename_y, filename_x)
    ...
    data_list = [mean_q_flux_850_v, mean_q_flux_850_v_rapid_growth, mean_q_flux_850_v_slow_growth]
    var_label = 'mean_q_flux_850_v'
    ...
    for i, data in enumerate(data_list):
        ...
        filetype_label = '%s_violin_by_%s%d' %(var_label, var_seperation_name, seperation_threshold)
